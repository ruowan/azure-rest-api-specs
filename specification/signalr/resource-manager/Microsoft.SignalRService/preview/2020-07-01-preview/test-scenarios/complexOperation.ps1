...
$storageAccountKey = Get-AzKeyVaultSecret -VaultName 'ruowan-vault1'  -Name 'storageAccountKey' -AsPlainText
$uploadUrl = Get-AzKeyVaultSecret -VaultName "ruowan-vault1" -Name "uploadUri" -AsPlainText
